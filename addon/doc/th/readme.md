...
* **การโทรด้วยเสียงและวิดีโอ**: สามารถกดโทรออกได้โดยตรงจากหน้าต่างแชท
...
* **ข้อจำกัด**: ปัจจุบันส่วนเสริมนี้ยัง**ไม่สามารถ**ใช้กดรับสายเรียกเข้าได้

## คีย์ลัด (Keyboard Shortcuts)

| คีย์ลัด | หมวดหมู่ | คำสั่ง |
|---|---|---|
| **NVDA+Shift+C** | LINE Desktop | เริ่มการโทรด้วยเสียง (Voice Call) |
| **NVDA+Shift+V** | LINE Desktop | เริ่มการโทรด้วยวิดีโอ (Video Call) |
| **NVDA+Shift+T** | LINE Desktop | เปิดหน้าต่างเลือกไฟล์แนบ (Attachment) |
